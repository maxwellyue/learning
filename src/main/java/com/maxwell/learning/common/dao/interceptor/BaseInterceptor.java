...
import com.maxwell.learning.common.dao.dialect.Dialect;
import com.maxwell.learning.common.dao.dialect.db.*;
	...
	protected static Page<Object> convertParameter(Object parameterObject, Page<Object> page) {
    	try{
            if (parameterObject instanceof Page) {
                ...
                //这种实现方式的前提是，传入Mapper文件的参数是拥有page属性的实体，通过反射的方式获取page
